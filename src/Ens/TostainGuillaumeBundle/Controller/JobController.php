...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EnsTostainGuillaumeBundle:Job:index.'.$format.'.twig', array(
            'categories' => $categories,
            'lastUpdated' => $em->getRepository('EnsTostainGuillaumeBundle:Job')->getLatestPost()->getCreatedAt()->format(DATE_ATOM),
    ...
    public function showAction(Job $job)
    {
        ...
        //$job = array('id' => $job->getId(), 'position' =>$job->getPosition(), 'company' => $job->getCompany(), 'type' => $job->getType(), 'location' => $job->getLocation(), 'companyslug' => $job->getCompanySlug(), 'locationslug' => $job->getLocationSlug(), 'positionslug' => $job->getPositionSlug());
